...
WEIGHT_DECAY = 0.10     # cautious weight decay for Muon (Phase 1 best: Exp100)
ADAM_BETAS = (0.76, 0.99) # Adam beta1, beta2
...
GRAD_CLIP = 2.0           # gradient clipping max norm (0 = no clipping)
